...
[[nodiscard]] CommandEncoder
Device::create_command_encoder() const
{
...
bool
DeviceFeatures::is_compatible_with(const DeviceFeatures &other) const
{
...
void
Device::immediate_submit(std::function<void(vk::CommandBuffer)> &&function
) const
{

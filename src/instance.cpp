...
get_required_instance_extensions(SDL_Window *window);
        ...
        std::sort(
          ...
          [](
            ...
            const std::shared_ptr<PhysicalDevice> &b
              ...
              int a_score = (a_type == vk::PhysicalDeviceType::eDiscreteGpu) ? 0
                            : (a_type == vk::PhysicalDeviceType::eIntegratedGpu)
                              ? 1
                              : 2;
              int b_score = (b_type == vk::PhysicalDeviceType::eDiscreteGpu) ? 0
                            : (b_type == vk::PhysicalDeviceType::eIntegratedGpu)
                              ? 1
                              : 2;
